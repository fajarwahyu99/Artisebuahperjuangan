...
public class JobSchedulersConstants {
    ...
    public static final long PERIOD_MILLIS_FETCH_POP_MOVIE = 24 * 60 * 60 * 1000L;
    ...
    public static final long PERIOD_MILLIS_DELETE_EXTRA_PIC = 24 * 60 * 60 * 1000L;

    public static final long PERIOD_MILLIS_UPDATE_WIDGET = 24 * 60 * 60 * 1000L;

    public static final long PERIOD_MILLIS_NOTIFICATION = 24 * 60 * 60 * 1000L;
