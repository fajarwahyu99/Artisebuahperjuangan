...
public class MovieProvider extends ContentProvider {
    ...
    /**
     * URI matcher code for the content URI for the cache movie most upcoming table
     */
    ...
    static {
        ...
        // The content URI of the form "content://com.example.infolabsolution.thelastsubmission/movie" will
        ...
        // For example, "content://com.example.infolabsolution.thelastsubmission/movie/3" matches, but
        // "content://com.example.infolabsolution.thelastsubmission/movie" (without a number at the end)
        // doesn't match.
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        switch (match) {
            ...
            case MOVIE_ID:
                ...
                // For an example URI such as "content://com.example.infolabsolution.thelastsubmission/movie/3",
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        // uri: content://com.example.infolabsolution.thelastsubmission/movie
