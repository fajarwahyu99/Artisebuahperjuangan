...
public class MovieContract {
     ...
     *
     *     content://com.example.infolabsolution.thelastsubmission/movie/
     *     [           BASE_CONTENT_URI          ][ PATH_MOVIE ]
     *
     * is a valid path for looking at movie data.
     *
     *      content://com.example.infolabsolution.thelastsubmission/givemeroot/
     *
    ...
    /**
     * Inner class that defines the table contents of the cache movie most upcoming table.
     */
    public static final class CacheMovieMostPopularEntry implements BaseColumns {

        /* The base CONTENT_URI used to query the cache movie most upcoming table from the content provider */
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon()
        ...
        /* Used internally as the name of the cache movie most upcoming table. */
        public static final String TABLE_NAME = "cache_movie_most_popular";

        /**
         * PosterPath is stored as a String representing movie's poster_path url, used for
         * display on main screen when user setting sortOrder by most upcoming.
         */
        public static final String COLUMN_POSTER_PATH = "poster_path";
